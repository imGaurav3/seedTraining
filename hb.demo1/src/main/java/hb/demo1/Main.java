...
public class Main {
	...
	public static void populate() {
		...
		//create(102, "Halo First", "Eric Nylund", 998);
		//create(102, "Halo Smoke", "Kelly Gay", 997);
		create(103, "Halo Rene", "Kelly Gay", 996);
		create(104, "Halo Last", "Troy Dennigs", 995);
		create(105, "Halo Silent", "Troy Dennigs", 994);
	}
